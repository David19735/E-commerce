...
const emailRegistro=async(datos)=>{
    ...
    await transport.sendMail({
        ...
        text:'Confirmación de tu cuenta en la tienda',
        html:`
            <p>Hola, ${nombre}, Comprueba tu cuenta www.tienda.com</p>
...
const emailPassword=async(datos)=>{
    ...
    await transport.sendMail({
        ...
        html:`
            ...
            <a href="http://localhost:3000/olvide-password/${token}">Cambiar contraseña</a>
            </p>
